  ...
  if (!hasResults) {
    return <div className="w-full h-full bg-lab-surface rounded-lg shadow-lg flex items-center justify-center">
        <div className="text-center max-w-sm px-6">
          ...
          <p className="text-sm text-lab-text-secondary">Build with confidence. GAIA’s professional language provides the control for predictable, scalable results your users will trust. Start your experiment on the left.</p>
        </div>
      </div>;
  }
