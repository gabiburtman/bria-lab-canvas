...
const LabInterface = () => {
  ...
  return <div className="h-screen flex flex-col bg-lab-background font-roboto overflow-hidden">
      ...
      <div className="flex flex-col gap-4 p-6 flex-none border-b border-lab-border/50">
        {/* First Row - Essential Branding & Primary CTA */}
        <div className="flex items-center justify-between">
          {/* Left - Logo & Title */}
          <div className="flex items-center gap-3">
            <img src="/lovable-uploads/41e99d95-4105-4ece-b06b-475e0b2e8f10.png" alt="Bria Logo" className="h-8 w-auto" />
            <h1 className="text-2xl font-google-sans font-medium text-lab-text-primary">GAIA Lab</h1>
          </div>

          {/* Right - Primary CTA */}
          <Button variant="default" className="bg-lab-primary hover:bg-lab-primary-hover text-lab-primary-foreground font-medium px-6 py-2 hover:shadow-lab-glow-primary transition-all">
            Bria Platform
            <ExternalLink className="ml-2 h-4 w-4" />
          </Button>
        </div>

        {/* Second Row - Description & Secondary Navigation */}
        <div className="flex items-center justify-between">
          {/* Left - Description & Learn More */}
          <div className="flex items-center gap-4">
            <p className="text-sm text-lab-text-secondary max-w-2xl leading-relaxed">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button variant="outline" size="sm" className="bg-lab-surface hover:bg-lab-interactive-hover border-lab-border text-lab-text-primary whitespace-nowrap">
                  Learn more
                </Button>
              </DialogTrigger>
          ...
          {/* Right - Secondary Navigation & User */}
          <div className="flex items-center gap-2">
            {/* External Links - Smaller and more subtle */}
            <div className="flex items-center gap-1">
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="icon" className="w-8 h-8 rounded-full bg-transparent hover:bg-lab-border/50 text-lab-text-muted hover:text-lab-text-secondary transition-all duration-200">
                    <img src="/lovable-uploads/d7168b47-d969-4810-b373-9a25ca8d305d.png" alt="Hugging Face" className="w-3.5 h-3.5" />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  <p>Hugging Face</p>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="icon" className="w-8 h-8 rounded-full bg-transparent hover:bg-lab-border/50 text-lab-text-muted hover:text-lab-text-secondary transition-all duration-200">
                    <img src="/lovable-uploads/ae118f43-dd1c-4862-9ac5-47b536da3b12.png" alt="Discord" className="w-3.5 h-3.5" />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  <p>Discord</p>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="sm" className="text-xs px-2 h-6 rounded bg-transparent hover:bg-lab-border/50 text-lab-text-muted hover:text-lab-text-secondary transition-all duration-200">
                    Research Paper
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="w-8 h-8 rounded-full bg-transparent hover:bg-lab-border/50 text-lab-text-muted hover:text-lab-text-secondary ml-2 transition-all duration-200">
